...
public class Main {
    public static void main(String[] args) throws IOException, JAXBException, ExecutionException {
        String resource = Lib.readResource("admi998.xml");
...
//        JaxbContextLoader.INSTANCE.get(SupplementaryDataEnvelope1.class, classesArray);
        ...
        mx.getAdmstnPrtryMsg().getPrtryData().getData().setAny(mxInnerDocument);
        ...
        System.out.println(mx.message(mxWriteConfiguration));
    }
}